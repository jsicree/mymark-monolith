...
CREATE TABLE `CUSTOMER` (
  ...
  CONSTRAINT `CUST_CART_FK` FOREIGN KEY (`SHOPPING_CART_ID`) REFERENCES `SHOPPING_CART` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `CART_LINE_ITEM` (
  ...
  CONSTRAINT `CART_FK` FOREIGN KEY (`CART_ID`) REFERENCES `SHOPPING_CART` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
