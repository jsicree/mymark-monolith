...
ALTER TABLE `mymark_mono`.`ACCOUNT` 
ADD CONSTRAINT `BILLING_ADDRESS_FK` FOREIGN KEY (`BILLING_ADDRESS_ID`) REFERENCES `ADDRESS` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ADD CONSTRAINT `CART_FK` FOREIGN KEY (`CART_ID`) REFERENCES `SHOPPING_CART` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `mymark_mono`.`CART_LINE_ITEM` 
ADD CONSTRAINT `PRODUCT_FK` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `PRODUCT` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
